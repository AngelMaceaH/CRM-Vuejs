<template>
  <tr>
    ...
    <td class="whitespace-nowrap px-3 py-4 text-sm">
      <button type="button" class="inline-flex rounded-full px-2 text-xs font-semibold leading-5 cursor-pointer"
    ...
    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
      ...
      <button type="button" class="text-red-600 hover:text-red-900"
        @click="$emit('eliminar-cliente', cliente.id)">Eliminar</button>
    </td>
  </tr>
</template>
<script setup>
